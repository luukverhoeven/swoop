pc.script.create('ui_ingame', function (context) {
    ...
    Ui_ingame.prototype = {
        initialize: function () {
            ...
            this.instructions = this.entity.findByName('Instructions');
        ...
        onEnable: function () {
            ...
            var pauseButton = this.entity.findByName('SpritePause');

            if (self.game.firstPlay) {
                ...
                var fn = function () {
                    ...
                    context.mouse.off("mousedown", fn, this);
                    if (context.touch) {
                        context.touch.off("touchstart", fn, this);
                    }
                };

                context.mouse.on("mousedown", fn, this);

                if (context.touch) {
                    context.touch.on("touchstart", fn, this);
                }
            }
        },
